  ...
  <Layout>
    ...
    <div style={{paddingBottom: '25px'}}>
	 ...
	 <tr>
      ...
      <div style={{paddingBottom: '25px'}}>
	      <h3>Experiments</h3>
	      Each of the nine methods is tested on two synthetic data sets.
	      <div style={{display: 'flex'}}>
		      <div style={{flexGrow: '1', flexBasis: '50%'}}>
			      <Image name='classificationData1' fluid/>
			      <p style={{textAlign: 'center'}}>#1</p>
		      </div>
		      <div style={{flexGrow: '1', flexBasis: '50%'}}>
			      <Image name='classificationData2' fluid/>
			      <p style={{textAlign: 'center'}}>#1</p>
		      </div>
	      </div>
	      <p><b>Fig. 2</b>  Synthetic data sets. The time tag is represented as the grey intensity. Earlier points are plotted with a lighter shade. The “ideal” selected set is shown with red target markers.</p>
      </div>
      <hr/>
      <div style={{paddingBottom: '25px'}}>
    ...
    <hr />
      <div style={{paddingBottom: '25px'}}>
	      <h3>Results</h3>
	      <Image name='classificationRank' fluid/>
	      <p><b>Fig. 3</b>  Average rank for each method for summaries of 40 randomly generated data sets (20 each following the cluster distributions of data sets #1 and #2). On each data set, summaries from all methods are compared and ranked. Better methods receive lower rank.</p>
      </div>
      <hr/>
      <div style={{paddingBottom: '25px'}}>
	      <Image name='spider' fluid />
	      <p><b>Fig. 4</b>  Average F-measure for each method in <a href="#methods">Table 1</a> compared to five user ground-truth summaries for  VSUMM video  #21. Method summaries are generated using HSV and RGB feature spaces. Summaries are matched using histograms of hue values for the selected frames.</p>
      </div>
      <hr/>
      <div style={{paddingBottom: '25px'}}>
      ...
      <div style={{paddingBottom: '25px'}}>
	      <h3>Example</h3>
	      <Image name='classificationV29SCX' fluid/>
	      <p><b>Fig. 5</b>  Comparison of VSUMM video #29 summaries from ground-truth user #3 and the SCX method. The matches have been calculated using the 16-bin histogram method with threshold 0.5. The F-measure for the match is 0.88.</p>
      </div>
      <hr/>
      <div>
	      <ol class="smallFont">
    ...
    <p>
	    Code:
            <a style={{paddingLeft: '5px'}} href="https://github.com/clarematthews/online-video-summarisation">GitHub</a>
    </p>
    <p>
            Data:
