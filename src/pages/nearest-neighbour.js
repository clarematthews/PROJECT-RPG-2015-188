...
const NearestNeighbourPage = () => (
  <Layout>
    ...
    <div style={{ position: 'relative', paddingBottom: '56.25%', paddingTop: '25px', height: '0' }}>
	    <iframe style={{ position: 'absolute', top: '0', left: '0', width: '100%', height: '100%' }} width="560" height="315" src="https://www.youtube.com/embed/08JABhcErAU?vq=hd720&modestbranding=1&controls=0&amp;" frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
    </div>
    <hr />
